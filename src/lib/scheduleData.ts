...
const BASE_SCHEDULE: ScheduleStop[] = [
  ...
  { time: "6:30 – 7:30 م", title: "لعبة الكنز", icon: "🗺️" },
  { time: "7:30 – 9:30 م", title: "ورش العمل", icon: "🛠️", note: "WORKSHOPS" },
  { time: "9:30 – 10:30 م", title: "لعبة الكنز", icon: "🗺️" },
  { time: "10:30 م – 12:00 ص", title: "حفلة السمر", icon: "🎉" },
];
...
const WORKSHOP_ROTATION: Record<TeamKey, string[]> = {
  A: ["النداهة", "عمل فني", "الدوامة", "سوشي"],
  B: ["عمل فني", "الدوامة", "سوشي", "النداهة"],
  C: ["الدوامة", "سوشي", "النداهة", "عمل فني"],
  D: ["سوشي", "النداهة", "عمل فني", "الدوامة"],
};
